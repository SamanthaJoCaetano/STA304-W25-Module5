...
`survey` library to run an estimation of the mean mass. Assume the study
instead collected the data by stratifying by species, where in the
population there 16 droids, 80 humans and 128 other species. Use the
finite population correction with $N=224$ to estimate the mean mass.

```{r}
table(starwars_clean$species_clean)

# In the sample there are 4 droids, 20 humans and 32 other species.
# In the population (text above) there are 16 droids, 80 humans and 128 other species.
