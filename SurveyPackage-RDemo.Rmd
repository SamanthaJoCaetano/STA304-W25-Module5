...
# In the sample there are 20 humans and 36 other species.

## Need to create a weight variable for 8% and then a second variable that spreads the weight amongst the sample.
